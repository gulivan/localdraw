...
Calm, personal, immediate. The workspace should feel dependable and close to the user's files, with quiet confidence rather than dashboard ceremony.

## Anti-references

- Admin dashboards dominated by navigation chrome, bulk controls, and identical metric-style cards.
- Heavy black borders, offset shadows, or decorative motion competing with the drawings.
- Cloud-first language that falsely implies hosted storage in the desktop app or on-device storage in the hosted app.
- Custom editor controls that replace or visually fight Excalidraw's native tools.
...
Target WCAG 2.2 AA. All workflows must support keyboard navigation, visible focus, non-color state cues, at least 4.5:1 body-text contrast, reduced motion, and responsive use from phone to desktop. Drag-and-drop actions require an equivalent menu or keyboard operation.
